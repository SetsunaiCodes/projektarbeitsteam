...
document.getElementById("collectionhoritem").addEventListener("click", collectionhor);
document.getElementById("collectionveritem").addEventListener("click", collectionver);
document.getElementById("friendlisthoritem").addEventListener("click", friendlisthor);
document.getElementById("friendlistveritem").addEventListener("click", friendlistver);
document.getElementById("angebotehoritem").addEventListener("click", angebotehor);
document.getElementById("angeboteveritem").addEventListener("click", angebotever);
...
function collectionhor(){
  if(this.classList.contains("headericon")){
    var collectionhorelement = document.querySelectorAll('.grid .collectionhor');
